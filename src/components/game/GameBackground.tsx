...
function PatternSVG({ id, accentColor }: { id: PresetId; accentColor: string }) {
  ...
  switch (id) {
    ...
    case 'scientist':
      return (
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
          <line x1="0" y1="33" x2="100" y2="33" stroke={a(0.25)} strokeWidth="1.0"/>
          <line x1="0" y1="66" x2="100" y2="66" stroke={a(0.25)} strokeWidth="1.0"/>
          <line x1="33" y1="0" x2="33" y2="100" stroke={a(0.25)} strokeWidth="1.0"/>
          <line x1="66" y1="0" x2="66" y2="100" stroke={a(0.25)} strokeWidth="1.0"/>
          <polygon points="50,8 58,13 58,23 50,28 42,23 42,13" stroke={a(0.50)} strokeWidth="2.0" fill="none"/>
          <line x1="0" y1="92" x2="100" y2="92" stroke={a(0.35)} strokeWidth="2.0"/>
          <circle cx="75" cy="22" r="2" fill={a(0.55)}/>
          <circle cx="25" cy="78" r="2" fill={a(0.45)}/>
        </svg>
      );
    case 'dark_mage':
      return (
